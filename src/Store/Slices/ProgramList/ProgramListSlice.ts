...
import { deleteProgramBuilder } from "./ProgramDelete";
import { getProgramListBuilder } from "./ProgramListGet";
import { patchProgramBuilder } from "./ProgramPatch";
import { postProgramBuilder } from "./ProgramPost";

export const initialState: IProgramList = {
...
export const ProgramListSlice = createSlice({
    name: "program-list", initialState,
    reducers: {
    ...
    extraReducers: builder => {
        getProgramListBuilder(builder);
        patchProgramBuilder(builder);
        postProgramBuilder(builder);
        deleteProgramBuilder(builder);
    }
})
...
export * from "./ProgramListGet";
export * from "./ProgramPatch";
export * from "./ProgramPost";
